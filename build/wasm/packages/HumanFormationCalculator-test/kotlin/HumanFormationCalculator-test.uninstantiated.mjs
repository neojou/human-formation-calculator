...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const wasmFilePath = './HumanFormationCalculator-test.wasm';
    ...
    try {
      ...
      if (isBrowser) {
        wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./HumanFormationCalculator-test.wasm',import.meta.url).href), importObject, { builtins: [''] })).instance;
      }
    } catch (e) {
